...
export default class _RequestPasswordChangePage extends React.Component {
        ...
        return (
            <Card className='main-card'>
                ...
                <Row style={{marginBottom: 10}}>
                    <Col md={3} sm={0}/>
                    <Col md={6} sm={12}>
                        <p className='explanation' style={{textAlign: 'justify'}}>
                ...
                <Row>
                    ...
                    <Col md={6} sm={12}>
                        <TextFieldComponent
                            label='Seu email'
                            optional={false}
                            placeHolder="Exemplo: meu_email@email.com"
                            value={request.email}
    ...
    setEmail(e) {
        this.setState({request: new EmailValidationRequest(e)})
    }
    ...
    submitRequest() {
        ...
        EmailValidationService.REQUEST_PASSWORD_CHANGE(request)
            .then(
                () => showToast(ToastUtils.BUILD_TOAST_SUCCESS_BODY('Mensagem enviada!'))
            ).catch(

...
export const SearchServicesPage = ({token, updateToken, user}) => {
    ...
    return (
        <>
            <_SearchServicesPage showToast={showToast} redirectTo={redirectTo}/>
        </>
    )
}

export default class _SearchServicesPage extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
